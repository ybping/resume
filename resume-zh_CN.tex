...
\begin{onehalfspacing}
	目前主要涉及的工作是AzureStack基础平台及其Service的监控组件AzureMonitor，我参与的主要工作包括：
	\begin{itemize}
		\item 把Agement搜集上报的时序数据进行有效的存储， 主要用到的技术是In-Memory Index, WAL, LSM等；
		\item 基于SignalR技术，实现了服务器到客户端的推送，实时更新服务端的监控信息；
